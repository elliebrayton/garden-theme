    ...
    <div class="site-content container row py-8 px-5 px-sm-0 mx-auto">
        ...
        <h2 class="search-title">Search Results for "<?php echo "<i>$s</i>"; ?>"</h2>
            <?php 
                if(have_posts()){ ?>
                    <?php 
                    echo "<p>Your term was found in the following posts and/or pages below.</p>"; ?>
                    <?php
                    while(have_posts()){
                        the_post(); ?>
            ...
            <?php 
                   ...
                   <?php 
                    echo "<p>It seems that what you were looking for is not found on our website. Please try another search.</p>"; 
                    get_search_form();
                   ?>
            <?php
                }
